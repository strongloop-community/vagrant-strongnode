...
then
    ...
    echo " 'slc run /var/strongnode-app-folder/myApp/app.js' to run the strong node node app in strongnode-app-folder/myApp"
		...
		echo "	api created with model types: store, customer, product "
		echo "..."
		...
		echo "machine configured to run your server:" 
		echo "vagrant ssh"
		echo "slc run /var/strongnode-app-folder/loopback-node-app/app.js"
		#echo "open a browser on your host machine:" 
		#echo "	to http://33.33.33.10:3000"
		#echo "	or http://33.33.33.10:3000/explorer"
